                ...
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--end::Select2-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Publicar o suspender sessiones en la web</div>
                            <!--end::Description-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--end::Select2-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7 mb-7">Agregar categoria de la sesion.</div>
                            <!--end::Description-->
                            <!--end::Input group-->
                            <!--begin::Button-->
                            ...
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Agregar Etiquetas a la sesiones.</div>
                            <!--end::Description-->
                            <!--end::Input group-->
                        </div>
                        <!--end::Card body-->
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="required form-label">Nombre de la sesion</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            ...
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">Indique un nombre de las sesiones que aparecera en su pagina.</div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="price" class="form-control mb-2"  placeholder="Precio de las sesiones" value=""  />
                                            </div>
                                        ...
                                        <div class="row mb-10">
                                            <div class="col-md-6">
                                                <!-- Duración -->
                                                <label class="required form-label">Duración (min)</label>
                                                <div class="input-group mb-2">
                                                    <input type="text" name="duration" class="form-control" placeholder="Duración en minutos ej: 55" value="" />
                                                    <div class="input-group-prepend"><span class="input-group-text">Minutos</span></div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-2">
                                                    <div class="input-group-prepend"><span class="input-group-text">#</span></div>
                                                    <input type="text" name="cantsession" class="form-control" placeholder="Cantidad de sesiones" value="" />
                                                </div>
                                                <div class="text-muted fs-7">La cantidad de sesiones necesarias</div>
                                            </div>
                                        </div>
                                        <!--begin::Input group-->
                                        ...
                                        <div class="d-none mb-10 fv-row"
                                            ...
                                            <!--begin::Label-->
                                            <label class="form-label">Indique el % de descuento que desea configurar</label>
                                            <!--end::Label-->
                                            <!--begin::Slider-->
                                            ...
                                            <!--end::Slider-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">Establezca un porcentaje de descuento que se aplicará a estas sesiones.</div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="d-none mb-10 fv-row" id="kt_ecommerce_add_product_discount_fixed">
                                            ...
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">Establezca el precio del producto con descuento. El producto se reducirá al precio fijo determinado</div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                            ...
                                            <div class="dropzone" id="kt_ecommerce_add_product_media">
                                                ...
                                                <div class="dz-message needsclick">
                                                    ...
                                                    <div class="ms-4">
                                                        ...
                                                        <span class="fs-7 fw-semibold text-gray-500">Puedes cargar hasta 3 imagenes</span>
                                                    </div>
                                                    <!--end::Info-->
                                                </div>
                                            </div>
