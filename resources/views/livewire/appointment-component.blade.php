<div>
            ...
            <div class="d-flex flex-stack flex-row-fluid">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-5">
                    ...
                    <a href="#" class="btn btn-flex btn-sm h-40px fw-bold btn-primary" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_add_kt_modal_add_appoinmetn">Nuevo
                    </a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
    ...
    <div id="kt_app_content" class="app-content">
        <div id="kt_app_content_container" class="app-container container-fluid">
         ...
         <div class="modal fade" id="kt_modal_add_kt_modal_add_appoinmetn" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
                        ...
                        <form id="kt_modal_add_user_form" class="form" action="#">
                            ...
                            <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fw-semibold fs-6 mb-2">Especialista</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select class="form-select form-select-solid" data-control="select2"
                                        data-placeholder="Select an option">
                                ...
                                <div class="fv-row mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">Hora inicio:</label>
                                    <input type="numeric" name="phone"
                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                        placeholder="hora" value="" />
                                </div>
