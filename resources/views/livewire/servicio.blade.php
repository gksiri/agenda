                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                ...
                                <i class="ki-outline ki-plus fs-2"></i>Nuevo Servicio</button>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                                                                ...
                                                                <div data-repeater-item>
                                                                    <div class="form-group row align-items-center">
                                                                        <div class="col-md-1">
                                                                            <div class="form-check form-check-custom">
                                                                                <div>
                                                                                    ...
                                                                                    <input class="form-check-input mb-2 mb-md-0" type="checkbox" value="" checked id="form_checkbox" />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <label class="form-label">Nombre:</label>
                                                                            <input type="text" class="form-control mb-2 mb-md-0" placeholder="Nombre del servicio" />
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                                ...
                                                                                <label class="required fw-semibold fs-6 mb-2">Duracion</label>
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <textarea class="form-control" maxlength="200" placeholder="Descripción del servicio" rows="1"></textarea>
                            ...
                            <tr>
                               ...
                               <td class="d-flex align-items-center">
                                ...
                                <td class="text-truncate" style="max-width: 200px;">
                                    este es un ejemplo de la descripcion de este servicio con un maximo de 200 caracteres
                                </td>    
                                <td>
