                ...
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--end::Select2-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Publicar o suspender el servicio en la web</div>
                            <!--end::Description-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--end::Select2-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7 mb-7">Agregar categoria del Servicio.</div>
                            <!--end::Description-->
                            <!--end::Input group-->
                            <!--begin::Button-->
                            ...
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Agregar Etiquetas al servicio.</div>
                            <!--end::Description-->
                            <!--end::Input group-->
                        </div>
                        <!--end::Card body-->
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">Indique un nombre para el servicio que aparecera en su pagina.</div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="price" class="form-control mb-2"  placeholder="Precio del Servicio" value=""  />
                                            </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="duration" class="form-control mb-2"  placeholder="Duracion en minutos ej: 55" value=""  />
                                                <div class="input-group-prepend"><span class="input-group-text">Minutos</span></div>
                                            </div>
                                            <div class="text-muted fs-7">La duracion debe ser en minutos</div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            ...
                                            <label class="fs-6 fw-semibold mb-2">Tipo de Descuento
                                                <span class="ms-1" data-bs-toggle="tooltip"
                                                    title="Elija un tipo de descuento que se aplicará a este servicio">
                                        ...
                                        <div class="d-none mb-10 fv-row"
                                            ...
                                            <!--end::Slider-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7">Establezca un porcentaje de descuento que se aplicará a este servicio.</div>
                                            <!--end::Description-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
